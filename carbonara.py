...
class GroupedGpuBasedTimeSeries(object):
    ...
    def gpu_sum(self):
        ...
        self.op_gpu = []
        cuda.start_profiler()
        self.data_gpu = gpuarray.empty(self.data.size, numpy.float32, strides=(stream_in_size,))
        self.op_gpu = gpuarray.empty(self.output.size, numpy.float32, strides=(stream_op_size,))
